...
import com.academy.integration.AbstractMongoDbTest.BasicExecutableNaming;
...
class AcademyIntegration extends Specification {
	...
	def setupSpec(){ 
		...
		mongodExecutable = runtime.prepare(new MongodConfigBuilder()
				...
				.net(new Net(PROCESS_PORT, Network.localhostIsIPv6())).build());
